...
namespace roport
{
  ...
  void RobotInterface::init()
  {
    ...
    pnh_.param<std::string>("joint_name_param_id", joint_name_param_id, "/hardware_interface/joints");

    std::vector<std::string> joint_names;
    if (!pnh_.getParam(joint_name_param_id, joint_names) || joint_names.empty()) {
